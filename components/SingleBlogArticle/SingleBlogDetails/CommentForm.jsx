...
const CommentForm = ({ bid }) => {
  ...
  return (
    <div>
      ...
      <>
        <div className="">
          <div className="max-sm:text-[11px] flex items-center max-sm:flex-row max-sm:items-start gap-1">
            <button className=" flex items-center gap-1 hover:bg-gray-300/90 max-sm:px-2 px-3 hover:rounded-md py-2 transition-all duration-300">
              <FiThumbsUp size={22} />
              <span> Like</span>
            </button>
            <button
              onClick={() => setisFormToggle(!isFormToggle)}
              className="flex items-center gap-1 hover:bg-gray-300/90 max-sm:px-2 px-3 hover:rounded-md py-2 transition-all duration-300"
            >
              <TbMessage size={22} />
              <span> Conmment</span>
            </button>
